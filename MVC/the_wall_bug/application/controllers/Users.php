...
class Users extends CI_Controller {
    ...
    */
    public function index() 
    {
        ...
        if(!$current_user_id) { 
            ...
            //echo 'here na ako sa login method';
        } 
        else {
            redirect("wall");
            //echo 'nakapasok ako fail';
        }
    ...
    */
    ...
    {
        //echo( 'here na ako sa login, ngclick ako sa button signin');
        $current_user_id = $this->session->userdata('user_id');
        if(!$current_user_id) { 
            $this->load->view('templates/header');
            $this->load->view('users/signin');
    ...
    */
    ...
    {   //add form_data
        ...
        {
            /**
             * wrong post name. [emails]. change the form name to [email]
             */
